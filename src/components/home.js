    ...
    return (
        <div className="Home">
            <div className="filterDrop">
                <h4>SAVED FILTERS</h4>
                <ul>
                    <li><input type="radio" id="f1" name="f1" />
                        <label for="f1">Filter 1</label>
                    </li>
                    <li><input type="radio" id="f2" name="f2" />
                        <label for="f2">Filter 2</label>
                    </li>
                    <li><input type="radio" id="f3" name="f3" />
                        <label for="f3">Filter 3</label>
                    </li>
                    <li><input type="radio" id="f4" name="f4" />
                        <label for="f4">Last Applied Filter</label>
                    </li>
                </ul>
                <h4>BRANDS</h4>
                <ul>
                    <li><input type="radio" id="b1" name="b1" />
                        <label for="b1">Nike</label>
                    </li>
                    <li><input type="radio" id="b2" name="b2" />
                        <label for="b2">Puma</label>
                    </li>
                    <li><input type="radio" id="b3" name="b3" />
                        <label for="b3">Adidas</label>
                    </li>
                    <li><input type="radio" id="b4" name="b4" />
                        <label for="b4">Reebok</label>
                    </li>
                </ul>
                <h4>COLORS</h4>
                <ul>
                    <li><input type="radio" id="c1" name="c1" />
                        <label for="c1">Black</label>
                    </li>
                    <li><input type="radio" id="c2" name="c2" />
                        <label for="c2">Gray</label>
                    </li>
                    <li><input type="radio" id="c3" name="c3" />
                        <label for="c3">Dark Blue</label>
                    </li>
                    <li><input type="radio" id="c4" name="c4" />
                        <label for="c4">Red</label>
                    </li>
                </ul>
                <h4>PRICE RANGE</h4>
                <ul>
                    <li><input type="radio" id="pr1" name="pr1" />
                        <label for="pr1">700-900</label>
                    </li>
                    <li><input type="radio" id="pr2" name="pr2" />
                        <label for="pr2">901-1100</label>
                    </li>
                    <li><input type="radio" id="pr3" name="pr3" />
                        <label for="pr3">1101-1500</label>
                    </li>
                    <li><input type="radio" id="pr4" name="pr4" />
